...
export default async function PartidosPage() {
  ...
  const { data: matchRows } = await supabase
    .from("matches")
    .select("id, phase, group_name, home_team, away_team, starts_at, status, home_score, away_score, minute, home_team_id, away_team_id, pen_score, winner_team_id, updated_at")
