...
export default function EditarPerfilForm({ initialProfile }: { initialProfile: ProfileRow }) {
  ...
  const [selectedPreset, setSelectedPreset] = useState<string | null>(
    initialProfile.avatar_url && PRESET_AVATARS.includes(initialProfile.avatar_url)
  ...
  const [favoriteTeam, setFavoriteTeam] = useState(initialProfile.favorite_team ?? "");
